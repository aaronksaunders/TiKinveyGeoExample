...
( function(undefined) {
		...
		var Base = Object.defineProperty(function() {
		}, 'extend', {
		...
		var Xhr = ( function() {
				...
				var getDeviceInfo = function() {
					...
					return ['Titanium', Titanium.Platform.osname, Titanium.Platform.version, Titanium.App.getGUID()// device ID.
					].map(function(value) {
		...
		Kinvey.Collection = Base.extend({
			...
			aggregate : function(aggregation, options) {
				...
				aggregation.setQuery(this.query);
				// respect collection query.
		...
		Kinvey.Query = Base.extend({
			 ...
			 */
			and : function(query) {
				this._set(Kinvey.Query.AND, query.builder, true);
				// do not throw.
				return this;
			},
			 ...
			 */
			or : function(query) {
				this._set(Kinvey.Query.OR, query.builder, true);
				// do not throw.
				return this;
			},
			...
			addCondition : function(field, condition, value) {
				switch(condition) {
					...
					case Kinvey.Query.WITHIN_CENTER_SPHERE:
						this._set(field, {
							$within : {
								$centerSphere : [value.center, value.radius]
							}
						});
						break;
