...
static NSString * const kkinvey_location_testJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_kinvey_location_testInjection
{
	...
	[html appendString:kkinvey_location_testJavascript];
...
{
	// attempt to make well-formed HTML and inject in our kinvey_location_test bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _kinvey_location_testInjection]];
