 ...
 * Copyright (c) 2009-2011 by kinvey_location_test, Inc. All Rights Reserved.
...
//@interface kinvey_location_testObject : NSObject
//@end

@interface kinvey_location_testObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[kinvey_location_testObject class]])
		{
			for (NSString *key in [[(kinvey_location_testObject*)o modules] allKeys])
			{
