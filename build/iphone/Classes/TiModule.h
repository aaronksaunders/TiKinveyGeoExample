...
/**
 The base class for all kinvey_location_test modules
 */
...
/**
 kinvey_location_test Platform calls this method on startup.
 */
-(void)startup;

/**
 kinvey_location_test Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 kinvey_location_test Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 kinvey_location_test Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 kinvey_location_test Platform calls this method on resume.
 @param sender The sender of the event.
 */
