...
// in simulator we redefine to format for kinvey_location_test Developer console
...
{\
	NSString * exceptionName = [@"org.kinvey_location_test." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.kinvey_location_test";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIkinvey_location_testNativeItemNone = -1, 
	UIkinvey_location_testNativeItemSpinner = -2,
	UIkinvey_location_testNativeItemProgressBar = -3,
	
	UIkinvey_location_testNativeItemSlider = -4,
	UIkinvey_location_testNativeItemSwitch = -5,
	UIkinvey_location_testNativeItemMultiButton = -6,
	UIkinvey_location_testNativeItemSegmented = -7,
	
	UIkinvey_location_testNativeItemTextView = -8,
	UIkinvey_location_testNativeItemTextField = -9,
	UIkinvey_location_testNativeItemSearchBar = -10,
	
	UIkinvey_location_testNativeItemPicker = -11,
	UIkinvey_location_testNativeItemDatePicker = -12,
	
	UIkinvey_location_testNativeItemInfoLight = -13,
	UIkinvey_location_testNativeItemInfoDark = -14,
	
	UIkinvey_location_testNativeItemDisclosure = -15,
	
	UIkinvey_location_testNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all kinvey_location_test instances of
