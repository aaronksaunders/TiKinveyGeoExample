...
@interface kinvey_location_testObject : KrollCoverageObject {
#else
@interface kinvey_location_testObject : KrollObject {
#endif
@private
...
extern NSString * kinvey_location_test$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	kinvey_location_testObject *_kinvey_location_test;
    KrollObject* console;
	BOOL shutdown;
