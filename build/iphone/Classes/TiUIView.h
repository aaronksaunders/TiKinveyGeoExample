...
/**
 Base class for all kinvey_location_test views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the kinvey_location_test view hierarchy (such as wrapped iOS UIViews) was touched.
