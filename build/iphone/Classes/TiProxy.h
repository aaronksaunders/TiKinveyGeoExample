...
//Rare exceptions to indicate a bug in the _kinvey_location_test code (Eg, function that a subclass should have implemented)
...
/**
 The base class for kinvey_location_test proxies.
 */
